...
<div id="content">
    <div class="login_body">
        ...
        <div>
            <input class="login_text1" type="password" placeHolder="请输入您的密码" >
        </div>
        <div class="login_btn">
...
.login_body .login_text{ margin-top:25px;width:100%; height: 40px; border:none; border-bottom: 1px #ccc solid; margin-bottom: 5px; outline: none; text-indent: 10px;}
