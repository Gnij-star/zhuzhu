...
<style scoped>
#content .cinema_menu{ width: 100%; height: 45px; border-bottom:1px solid #e6e6e6; display: flex;display:flexbox;
 justify-content:space-around; align-items:center; background:lwhite;}
</style>